...
//   const greaterProb = visualScore > verbalScore ? "Visual" : "Verbal";

//   if (greaterProb == lastPref) {
//     return lastPref;
//   } else {
//     return greaterProb;
//   }
...
// function isStyleChangeDetected(lastPref, visualScore, verbalScore) {
//   if (!lastPref || visualScore === undefined || verbalScore === undefined) {
//     return false; // Not enough data to determine if a change occurred
//   }
//   console.log("Checking for style change. Last Pref: ", lastPref);
//   console.log("Checking for style change. Visual Score: ", visualScore);
//   console.log("Checking for style change. Verbal Score: ", verbalScore);
//   const greaterProb = visualScore > verbalScore ? "Visual" : "Verbal";

//   console.log(
//     "Checking for style change result: ",
//     greaterProb && greaterProb !== lastPref,
//   );
//   return greaterProb && greaterProb !== lastPref;
// }
...
//   const [showStyleChangeModal, setShowStyleChangeModal] = useState(
//     isStyleChangeDetected(lastPref, visualScore, verbalScore),
//   );

//   // const hasShownModal = useRef(false);
//   // const currentSessionPref = useRef(lastPref);

//   // useEffect(() => {
//   //   // Wait for data to load
//   //   if (lastPref && visualScore !== undefined && verbalScore !== undefined) {
//   //     const newlyCalculatedPref =
//   //       visualScore > verbalScore ? "Visual" : "Verbal";

//   //     // If the newly calculated preference doesn't match the one we are
//   //     // currently showing them...
//   //     if (newlyCalculatedPref !== currentSessionPref.current) {
//   //       setShowStyleChangeModal(true); // Show the modal

//   //       // Update our tracker so we don't show the modal again
//   //       // UNLESS it flips back!
//   //       currentSessionPref.current = newlyCalculatedPref;
//   //     }
//   //   }
//   // }, [lastPref, visualScore, verbalScore]);

//   // useEffect(() => {
//   //   // 1. Wait until the hooks have actually returned real data
//   //   if (lastPref && visualScore !== undefined && verbalScore !== undefined) {
//   //     // 2. If the style changed AND we haven't shown the modal yet
//   //     if (isStyleChangeDetected(lastPref, visualScore, verbalScore)) {
//   //       setShowStyleChangeModal(true);
//   //       // hasShownModal.current = true; // Mark it as shown so it doesn't pop up again on next slide
//   //     }
//   //   }
//   // }, [lastPref, visualScore, verbalScore]);
...
function LectureStudent() {
  ...
  // lastPref !== getCurrentMode(lastPref, visualScore, verbalScore) &&

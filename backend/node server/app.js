...
const BlockedRecord = require("./models/blocked");
...
app.use(
  cors({
    origin: [
      ...
      "https://pretest.adaptivecomputationalthinkingeducation.app",
      "https://postest-survey.adaptivecomputationalthinkingeducation.app",
      "https://www.adaptivecomputationalthinkingeducation.app",
